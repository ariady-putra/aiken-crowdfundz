    ...
    <>
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">Claim All No Datum UTXOs</ModalHeader>
              <ModalBody>
                {/* Add Signer */}
                ...
                <div className="relative">
                  <Button
                    onPress={() => {
                      ...
                      hackCampaign(walletConnection, { action: "claimNoDatumUTXOs", params: { addSigner, outRef: { yes: false } } }, campaign)
                        .then(onSuccess)
                        .catch(onError)
                        .finally(onClose);
                    }}
